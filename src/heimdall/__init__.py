...
# Stage 4 — Physics, DSP, TDOA, multi-node pipeline
...
from .multi_node_pipeline import (
    MultiNodeDetectionResult,
    MultiNodePipeline,
    MultiNodePipelineConfig,
    NodePairCorrelation,
...
__all__ = [
    ...
    "VerificationChain",
    "validate_decorator",
    # Visualization — debris population
    "DebrisCloud",
    "DebrisPopulationBin",
    "DebrisPopulationSnapshot",
    "FragmentationEvent",
    ...
    "SyntheticPowerLawModel",
    "FRAGMENTATION_EVENT_CATALOG",
    # Visualization — radar detectability
    "DetectionGapAnalysis",
    "IonosphericWakeCurve",
    "RadarDetectionCurve",
    "RadarDetectabilityAnalyzer",
